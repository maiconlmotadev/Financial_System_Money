...
namespace Infrastructure.Repository.Generics
{
    public class GenericsRepository<T> : InterfaceGeneric<T>, IDisposable where T : class
    {
        ...
        // Garantir que recursos sejam liberados corretamente quando um objeto é descartado. É especialmente útil para gerenciar recursos como arquivos, conexões de banco de dados ou memória não gerenciada. 
